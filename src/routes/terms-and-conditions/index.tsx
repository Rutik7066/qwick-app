  ...
  return (
    <div className="flex flex-col justify-between min-w-full min-h-screen">
      ...
      <div className="flex flex-col justify-center items-center my-10  ">
        <h1 className="text-6xl  font-bold font-mono">Terms And Conditions</h1>
        <div className="flex  justify-center items-center w-full m-5">
          <p className="text-xl  font-bold font-mono w-full px-10">
            These Terms and Conditions constitute a legally binding agreement
            made between you, whether personally or on behalf of an entity
            (“you”) and Photography Manager pvt. ("Company", “we”, “us”, or
            “our”), concerning your access to and use of the
            http://www.photograhymanager.in website as well as any other media
            ...
            Sindkhed Raja, Buldhana, Maharastra 443203. You agree that by
            ...
            they reside (generally under the age of 18) must have the permission
            of, and be directly supervised by, their parent or guardian to use
            the Site. If you are a minor, you must have your parent or guardian
            read and agree to these Terms and Conditions prior to you using the
            Site.
          </p>
        </div>
      </div>
