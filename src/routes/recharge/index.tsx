...
export default component$(() => {
    ...
    useServerMount$(async () => {
        const jsonData = await fetch('https://nxhpt4pbmb.execute-api.ap-south-1.amazonaws.com/getplan')
    ...
    return (
        <div className="flex flex-col justify-between items-center min-w-full min-h-screen">
            ...
            <div className="flex flex-col  shadow-2xl rounded-xl px-5 py-4  w-1/3 space-y-2 justify-center items-center">
                    ...
                    plandata.data.plan.map((e: plan) => {
                        return <div onClick$={() => {
                            ...
                            <div className="text-start mx-4">
                                ...
                                <h1 className="font-semibold text-sm">{'Price \u20B9 ' + e.name}</h1>
                                <h1 className="font-semibold text-sm">{"Validity : " + e.validity}</h1>
                            </div>
                ...
                <button
                    onClick$={async () => {
                        console.log("amount" + (plandata.data.selectedplan.price * 100).toString());
                        ...
                        fetch("https://nxhpt4pbmb.execute-api.ap-south-1.amazonaws.com/createorder", {
                            ...
                            body: JSON.stringify({
                                ...
                                notes: {
                                    purpose: "Recharge of " + plandata.data.selectedplan.price.toString(),
                                },
                            }),
                        })
                            .then((data) => data.json())
                        ...
                        const reqBody = {
                            ...
                            "description": "Recharge of " + plandata.data.selectedplan.credit + " images.",
                            ...
                            "handler": function (r) {
                                ...
                                fetch('https://nxhpt4pbmb.execute-api.ap-south-1.amazonaws.com/updatecredit', {
                                    method: "POST",
                                    body: JSON.stringify({
